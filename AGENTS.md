...
- Mỗi lần tải hoặc reload ứng dụng, màn hình chào thương hiệu hiển thị khoảng 1,9 giây, bắt đầu mờ dần ở 1,5 giây. Nội dung liên hệ phải dùng chung `footerContacts`, timer và khóa cuộn phải được cleanup khi unmount, giao diện phải responsive và không tải thêm asset/CDN ngoài logo có sẵn.
