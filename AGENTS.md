...
- Sau mỗi công việc làm thay đổi code, cấu hình hoặc dependency, cập nhật mục **Nhật ký thay đổi (Changelog)** trong `README.md` bằng khối thẻ đóng/mở `<details><summary>...</summary></details>` cho từng phiên bản để người đọc có thể mở rộng xem chi tiết hoặc thu gọn lại giúp tài liệu luôn gọn gàng và không rối mắt.
