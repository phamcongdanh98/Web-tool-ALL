...
- Thêm màn hình chào khi mở hoặc reload website: logo PDFTools, tên người phát triển **Danh Phạm**, liên hệ Facebook/Zalo/Telegram, phiên bản và thanh tiến trình; hiển thị khoảng 1,9 giây rồi tự mờ để vào trang chính. Giao diện dùng CSS nội bộ, responsive, hỗ trợ giảm chuyển động và không thêm dependency.
