...
/**
 * Loại bỏ tiền tố hành chính chuẩn (Tỉnh, TP, Quận, Huyện, Thị xã, Xã, Phường, Thị trấn)
 */
export const stripAdminPrefix = (str = '') => {
  ...
  // 1. Tiền tố đầy đủ
  cleaned = cleaned.replace(/^(thành phố trực thuộc trung ương|thành phố|thị xã|tỉnh|quận|huyện|phường|thị trấn|xã|đặc khu)\s+/i, '')
